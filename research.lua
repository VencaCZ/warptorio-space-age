...
ExtendTech(t,{name="warp-biochamber-platform-4",unit={count=10000,ingredients = SciencePacks({red=1,green=1,gleba=1,blue=1,white=1,aquilo=1,final=1}),time=60}, prerequisites={"warp-biochamber-platform-3"},effects={}})
