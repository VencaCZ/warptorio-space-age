...
local local_settings = {
  ...
  biter = {
    ...
    evolution = {
       base = 0,
       researches = {
          {name = "warp-ground-platform-4", factor = 0.1},
          {name = "warp-factory-platform-3", factor = 0.15},
          {name = "warp-ground-platform-5", factor = 0.2},
          {name = "warp-factory-platform-4", factor = 0.3},
          {name = "warp-ground-platform-6", factor = 0.4},
          {name = "warp-factory-platform-5", factor = 0.5},
          {name = "warp-ground-platform-7", factor = 0.6},
          {name = "warp-factory-platform-6", factor = 0.7},
          {name = "warp-ground-platform-8", factor = 0.8},
          {name = "warp-factory-platform-7", factor = 0.9},
